...
mkdir -p src test docs/mysuperpowers/plans

# Create a simple implementation plan
cat > docs/mysuperpowers/plans/implementation-plan.md <<'EOF'
...
PROMPT="Execute the implementation plan at docs/mysuperpowers/plans/implementation-plan.md using the mysuperpowers:subagent-driven-development skill.
...
# Test 6: Git commits show proper workflow
