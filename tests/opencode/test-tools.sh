...
# and bundled mysuperpowers skills.
...
# Test 3: Test bundled mysuperpowers skill loading
echo ""
echo "Test 3: Testing native skill tool with a mysuperpowers skill..."
...
# Test 4: Test TDD skill loading
echo ""
echo "Test 4: Testing native skill tool with tdd skill..."

run_opencode output "$TEST_HOME/test-project" "Call the skill tool with name \"tdd\". Then tell me what the skill is about."
assert_contains "$output" '"name":"tdd"' "native skill tool loaded bundled tdd skill"

# Test 5: Test diagnose skill loading
echo ""
echo "Test 5: Testing native skill tool with diagnose skill..."

run_opencode output "$TEST_HOME/test-project" "Call the skill tool with name \"diagnose\". Then tell me what the skill is about."
assert_contains "$output" '"name":"diagnose"' "native skill tool loaded bundled diagnose skill"
